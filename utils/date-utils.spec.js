...
describe('Date utils', () => {
  ...
  describe('Format Date', () => {
    ...
    it('formats dates correctly without taking into account that they are in a different timezone', () => {
      const actualDate = formatDate(
        new Date('2021-06-08T00:01:00.000+08:00'),
        new Date('2021-06-09T00:01:00.000+08:00')
      )
      const expectedDate = 'June 8-9, 2021'
